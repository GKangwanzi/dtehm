...
<h4 class="fs-18 fw-semibold m-0">New Product</h4>
</div>
...
<div class="mb-3">
    ...
    <input type="number" id="example-email" name="example-email" class="form-control">
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <textarea class="form-control" id="example-textarea" rows="13" spellcheck="false"></textarea>
</div>
<div class="mb-3">
