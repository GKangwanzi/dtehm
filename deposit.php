...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        ...
        <button style="margin-left: 10px;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#transferModal">
            Commission <i data-feather="arrow-right"></i> Wallet
        </button>
    </div>
...
<div class="modal fade" id="transferModal" tabindex="-1" aria-labelledby="exampleModalgridLabel">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalgridLabel">New Deposit</h5>
...
<div class="mb-3">
    <button name="transfer" class="btn btn-primary form-control" type="submit">Transfer Now</button>
</div>
